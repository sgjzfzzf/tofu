...
def get_model_utility(eval_result_dict):
    ...
    for k, v in eval_result_dict.items():
        ...
        # getting Truth Ratio
        avg_paraphrase_np_values = np.array(
            list(eval_result_dict[k]["avg_paraphrased_loss"].values())
        )

        avg_perturbed_np_values = np.array(
            list(eval_result_dict[k]["average_perturb_loss"].values())
        )
